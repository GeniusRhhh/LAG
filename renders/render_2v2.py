...
num_agents = 4
render = True
ego_policy_index = 228
enm_policy_index = 160
episode_rewards = 0
ego_run_dir = "../scripts/results/MultipleCombat/2v2/ShootMissile/HierarchySelfplay/mappo/v1/run49"
enm_run_dir = "../scripts/results/MultipleCombat/2v2/ShootMissile/HierarchySelfplay/mappo/v1/run49"
