#!/usr/bin/env python3
"""
简单钳形夹击测试 - 直接修改现有任务的normalize_action方法
"""
    ...
    try:
        ...
        for step in range(max_steps):
            ...
            if step % 20 == 0:
                ...
                print(f"步骤 {step}: 存活飞机 {alive_count}")
                ...
                for agent_id, agent in env.agents.items():
                    if agent.is_alive:
                        ...
                        print(f"  {agent_id}: pos=({pos[0]/1000:.1f}, {pos[1]/1000:.1f})km, hdg={heading:.1f}°")
