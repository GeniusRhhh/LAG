...
from core import TacticSelector, TacticalDecisionManager
from intent import OurIntentSystem, ProjectIntentRecognizer
...
def test_enemy_intent():
    ...
    recognizer = ProjectIntentRecognizer()
