    ...
    try:
        ...
        while step < max_steps:
            ...
            if step % 60 == 0:  # 60步 = 12秒
                ...
                # 输出调试信息
                print(f"[TIME] 当前时间: {current_time:.1f}秒 | 步数: {step} | 距离: {min_dist/1000:.1f}km | 战术: {tactic}")
                logging.info(f"[TIME] 当前时间: {current_time:.1f}秒 | 步数: {step} | 距离: {min_dist/1000:.1f}km | 战术: {tactic}")
