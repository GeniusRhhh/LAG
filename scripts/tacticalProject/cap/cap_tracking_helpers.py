...
def _update_intent_recognition(self, env, current_time: float):
    ...
    source_threats = self._get_picture_threats(current_time=current_time, purpose="decision")
    if not source_threats:
        source_threats = self._get_picture_threats(current_time=current_time, purpose="search")
    if not source_threats:
        source_threats = self._get_picture_threats(current_time=current_time, purpose="raw")
