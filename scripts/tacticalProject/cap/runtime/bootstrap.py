...
def _configure_environment(my_aircraft_type: str, enemy_aircraft_type: str) -> None:
    ...
    os.environ["CAP_ENEMY_DIRECT_RTB_ENABLED"] = "0"
    os.environ["CAP_ENEMY_DIRECT_RTB_DISTANCE_KM"] = "40"
    os.environ["ENEMY_TURNBACK_DISTANCE_KM"] = "46"
    os.environ["ENEMY_HARD_STANDOFF_DISTANCE_KM"] = "42"
    os.environ["ENEMY_REATTACK_DISTANCE_KM"] = "72"
    os.environ["ENEMY_REGROUP_RELEASE_DISTANCE_KM"] = "72"
    os.environ["ENEMY_PULLBACK_DISTANCE_KM"] = "28"
    os.environ["ENEMY_REGROUP_TIMEOUT_S"] = "10"
    os.environ["ENEMY_REGROUP_MIN_HOLD_S"] = "6"
    os.environ["ENEMY_REGROUP_DEPART_MARGIN_KM"] = "12"
    os.environ["ENEMY_TURN_PHASE_S"] = "5"
    os.environ["ENEMY_REATTACK_HOLD_S"] = "2"
    os.environ["ENEMY_TURN_SOUTH_MIN_HOLD_S"] = "5"
    os.environ["ENEMY_TURN_SOUTH_DEPART_MARGIN_KM"] = "4"
    os.environ["ENEMY_RECOVERY_HOLD_S"] = "5"
    os.environ["ENEMY_RTB_ENABLED"] = "0"
    os.environ["ENEMY_SECOND_ATTACK_PROB"] = "0"
