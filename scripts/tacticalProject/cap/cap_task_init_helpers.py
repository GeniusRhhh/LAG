...
def initialize_cap_task(self):
    ...
    self._stable_tracking_window_s = 5.0
    self._stable_tracking_unique_window_s = 5.0
    self._stable_tracking_min_quality = 0.45
    self._stable_tracking_grace_s = 2.5
    self._stable_tracking_holdover_s = 0.6
    ...
    self._dynamic_control_update_distance = None
    ...
    self._relay_switch_count = {}
    self._relay_previous_guide = {}
    self._relay_previous_guide_time = {}
    self._relay_terminal_lock_until = {}

    self._guidance_verify = {
        'prelaunch_gate_pass_count': 0,
        'prelaunch_gate_block_count': 0,
        'prelaunch_gate_unique_pass_count': 0,
        'prelaunch_gate_unique_block_count': 0,
        'prelaunch_gate_ready_pass_count': 0,
        'prelaunch_gate_ready_block_count': 0,
        'prelaunch_gate_ready_unique_pass_count': 0,
        'prelaunch_gate_ready_unique_block_count': 0,
        'prelaunch_gate_request_after_ready_count': 0,
        'prelaunch_gate_request_after_ready_unique_count': 0,
        'prelaunch_gate_block_stable_not_ready_count': 0,
        'prelaunch_gate_block_friendly_safe_count': 0,
        'prelaunch_gate_block_long_shot_count': 0,
        'prelaunch_gate_block_launch_exec_fail_count': 0,
        'prelaunch_gate_block_other_count': 0,
        'prelaunch_gate_pass_by_target': {},
        'prelaunch_gate_block_by_target': {},
        'prelaunch_gate_block_by_reason': {},
        'prelaunch_gate_first_pass_time_by_target': {},
        'relay_attempt_count': 0,
        'relay_success_count': 0,
        'relay_unique_attempt_count': 0,
        'relay_unique_success_count': 0,
    ...
    self._external_gate_unique_pass_last_time = {}
    self._external_gate_unique_block_last_time = {}
    self._external_gate_ready_unique_pass_last_time = {}
    self._external_gate_ready_unique_block_last_time = {}
    self._external_gate_ready_unique_request_last_time = {}
    ...
    self._relay_unique_attempt_last_time = {}
    self._relay_unique_success_last_time = {}
