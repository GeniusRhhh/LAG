...
--env-name ${env} --algorithm-name ${algo} --scenario-name ${scenario} --experiment-name ${exp} \
    --seed ${seed} --n-training-threads 1 --n-rollout-threads 2 --cuda --log-interval 10 --save-interval 10 \
    --use-selfplay false --selfplay-algorithm "fsp" --n-choose-opponents 0 \
