...
class Runner(object):
    ...
    def restore(self):
        policy_actor_state_dict = torch.load((str(self.model_dir) + '/actor_latest.pt'),weights_only=True,map_location=torch.device('cpu'))
        self.policy.actor.load_state_dict(policy_actor_state_dict)
        policy_critic_state_dict = torch.load((str(self.model_dir) + '/critic_latest.pt'),weights_only=True,map_location=torch.device('cpu'))
